            ...
            <div className="flex w-full flex-col px-0 pb-10 md:px-5">
                ...
                <div className="grid w-full grid-cols-1 gap-px">
                    <div className="flex h-11 w-full md:h-12.5">
                        <label className="mr-px flex w-25 shrink-0 items-center justify-center bg-[#07172d] px-0.5 text-center text-xs leading-tight text-[#aaaaaa] md:w-37.5 md:text-[15px] md:leading-12.5">
                            아이디
                        </label>
                        <div className="relative flex flex-1 items-center bg-[#0d1d32] px-2.5">
                            <span className="text-[#ef7c00]">{user?.userName ?? ""}</span>
                        </div>
                    </div>
                    <div className="flex h-11 w-full md:h-12.5">
                        <label className="mr-px flex w-25 shrink-0 items-center justify-center bg-[#07172d] px-0.5 text-center text-xs leading-tight text-[#aaaaaa] md:w-37.5 md:text-[15px] md:leading-12.5">
                        ...
                        <div className="relative flex flex-1 justify-center bg-[#0d1d32]">
                            <input
                                ...
                                className="w-full bg-transparent px-2 text-right text-sm text-[#ef7c00] outline-none placeholder:text-gray/50 md:px-2.5 md:text-lg"
                            />
                        </div>
                    </div>
                    <div className="flex h-11 w-full md:h-12.5">
                    ...
                    <div className="relative z-10 mt-3 mb-px flex h-12 shrink-0 items-center bg-[#07172d] md:h-15.5">
                        <span
                            className="ml-3 block min-w-0 flex-1 overflow-hidden text-ellipsis whitespace-nowrap text-sm font-semibold leading-12 text-gray md:ml-5 md:text-base md:leading-15.5"
                            style={{ textShadow: "0 0 10px rgb(0 0 0 / 50%)" }}
                        >
                    ...
                    <div className="flex min-h-11 w-full items-stretch md:h-12.5">
                        <label className="mr-px flex w-25 shrink-0 items-center justify-center bg-[#07172d] px-0.5 text-center text-[10px] leading-tight text-[#aaaaaa] sm:text-xs md:w-37.5 md:text-[15px] md:leading-12.5">
                            기존 비밀번호
                        </label>
                        <div className="relative flex flex-1 items-center bg-[#0d1d32] px-2 md:px-2.5">
                            <input
                                ...
                                placeholder="기존 비밀번호"
                                className="w-full bg-transparent text-right text-xl text-[#ef7c00] outline-none placeholder:text-xs placeholder:tracking-widest placeholder:text-white md:text-2xl md:placeholder:text-lg"
                            />
                        </div>
                    </div>
                    <div className="flex min-h-11 w-full items-stretch md:h-12.5">
                    ...
                    <div className="flex min-h-11 w-full items-stretch md:h-12.5">
                        ...
                        <div className="relative flex flex-1 items-center bg-[#0d1d32] px-2 md:px-2.5">
                            <input
                                ...
                                placeholder="비밀번호확인"
                                className="w-full bg-transparent text-right text-lg text-[#ef7c00] outline-none placeholder:text-xs placeholder:tracking-widest placeholder:text-white md:text-2xl md:placeholder:text-lg"
                            />
                        </div>
                    </div>
                    <Button
                        ...
                        disabled={saving}
                        className="mt-px h-20 w-full rounded-none px-6 text-base font-normal text-gray disabled:opacity-50 md:h-25 md:px-12.5 md:text-lg"
                    >
                        {saving ? "처리중..." : "변경하기"}
                    </Button>
                </div>
