...
const menuItemClassName = cn(
  ...
  "rounded-[10px] border border-line bg-background text-ink",
  "shadow-[inset_0_1px_#c6a15b14]",
  // shared hover
  "hover:border-[rgba(198,161,91,0.22)]",
  "hover:bg-[linear-gradient(90deg,#c6a15b2e,#c6a15b0d)]",
  "hover:shadow-[0_8px_24px_-12px_#c6a15b66,inset_0_1px_#ffffff0d]",
  ...
  "lg:before:rounded-r lg:before:bg-[linear-gradient(180deg,#e8d5a3,var(--color-gold))]",
...
const menuItemActiveClassName = cn(
  ...
  // mobile active
  "max-lg:bg-[linear-gradient(180deg,#c6a15b29,#c6a15b0d)]",
  "max-lg:shadow-[0_4px_16px_-8px_#c6a15b59]",
  // desktop (lg+) active
  "lg:translate-x-[3px] lg:before:h-[58%]",
  "lg:bg-[linear-gradient(90deg,#c6a15b2e,#c6a15b0d)]",
  "lg:shadow-[0_8px_24px_-12px_#c6a15b66,inset_0_1px_#ffffff0d]",
);
  ...
  return (
    <aside
      className={cn(
        ...
        "bg-[linear-gradient(180deg,#fffcf7_0%,#e4d7c3_100%)]",
        ...
        "lg:bg-[linear-gradient(180deg,#fffcf7_0%,#e4d7c3_62%,#f7f4ee_100%)]",
        "lg:shadow-[8px_0_28px_-16px_rgba(90,70,30,0.16)] lg:duration-200",
    ...
    >
      <div
        className={cn(
          ...
          "max-lg:[scrollbar-width:thin] max-lg:[scrollbar-color:#c6a15b_transparent]",
          ...
          {SIDEBAR_NAV.map((item) => {
            ...
            return (
              ...
              >
                ...
                <span
                  className={cn(
                    "relative z-1 whitespace-nowrap text-ink",
                    "max-lg:text-[11px]",
                    "lg:text-base",
                    active ? "text-gold-soft" : "text-ink",
                  )}
                >
                  {item.label}
                </span>
